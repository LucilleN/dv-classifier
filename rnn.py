"""
This script runs our recurrent neural network  and either trains a new model from scratch, 
or loads a previously trained model, then evaluates that model on the testing set. 

Usage:
- Run this script with `python3 rnn.py` to evaluate the trained model on the testing set.
...
from utils import train_model, evaluate_model, parse_command_line_args, load_data_tensors
